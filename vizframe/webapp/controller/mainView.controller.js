sap.ui.define([
    ...
    "use strict";
    return Controller.extend("vizframe.controller.mainView", {
        onInit: function () {
            var data = [{
                "Category": "Category 1",
                "Revenue": 100
        ...
        onDatasetSelecteheatmap: function(oEvent){
            this.byId("chartContainer").setVizType('heatmap');
        },
        onDatasetSelecteradar: function(oEvent){
            this.byId("chartContainer").setVizType('radar');
        },
        onDatasetSelectedonut: function(oEvent){
            this.byId("chartContainer").setVizType('donut');
        },
        onDatasetSelectepie: function(oEvent){
            this.byId("chartContainer").setVizType('pie');
        }
    });
});